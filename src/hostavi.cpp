...
int hostavi_pipeline (char *argv) {
    GIOChannel *io_stdin;
    ...
    GstPad *sinkpad_audio = gst_element_get_static_pad(avi.udp_audio_sink, "sink");
    GstPad *sinkpad_video = gst_element_get_static_pad(avi.udp_video_sink, "sink");
